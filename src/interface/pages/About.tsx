...
function About() {
    return (
        <div id="about" className="mt-8">
                <Reveal direction="fade"delay={1} >
                      <h2 className="text-2xl md:text-3xl font-stretch-50%">Get to know the story behind the code.</h2>  
            <div className="mt-4">
            ...
            <div>
                ...
                <div>
                    ...
                    <div>
                        <SkillsList title="Languages" skills={[{ image: js, classname: "md:w-30" }, { image: ts, classname: " md:w-30" }, { image: php, classname: " md:w-30" }, { image: sql, classname: "w-17 md:w-20" }, { image: nosql, classname: "md:w-30" }]} />
                        <SkillsList title="Stacks & Librairies" skills={[{ image: express, classname: "md:w-30" }, { image: laravel, classname: "w-30" }, {image: react, classname: "md:w-30 " },{ image: native, classname: "w-50 md:w-35" }, { image: vue, classname: "md:w-25" }]} />
                        <SkillsList title="Databases" skills={[{ image: postgres, classname: "md:w-30" }, { image: mysql, classname: "md:w-30" },{ image: mongo, classname: "md:w-25" }, { image: sqlite, classname: "md:w-25" }]} />
                        <SkillsList title="Web technologies" skills={[{ image: html, classname: "w-13 md:w-10" }, { image: css, classname: "md:w-20" }, { image: tailwind, classname: "md:w-35" }, { image: rest, classname: "md:w-20" }]} />
                        <SkillsList title="Tools" skills={[{ image: git, classname: "md:w-25" }, { image: github, classname: "md:w-30" }, { image: docker, classname: "md:w-30" }, { image: n8n, classname: "md:w-30" }]} />
                    </div>
                </div>
            </div>
        </div>
